...
namespace Chords.Android.Models
{
    public class FindChordModel
    {
		...
		{
			{ NamingConvention.English, new [] { "C", "C#", "Db", "D", "D#", "Eb", "E", "F", "F#", "Gb", "G", "G#", "Ab", "A", "A#", "Bb", "B" } },
			{ NamingConvention.German, new [] { "C", "C#", "Db", "D", "D#", "Eb", "E", "F", "F#", "Gb", "G", "G#", "Ab", "A", "A#", "B", "H" } },
			{ NamingConvention.Latin, new [] { "Do", "Do#", "Reb", "Re", "Re#", "Mib", "Mi", "Fa", "Fa#", "Solb", "Sol", "Sol#", "Lab", "La", "La#", "Sib", "Si" } }
		};
